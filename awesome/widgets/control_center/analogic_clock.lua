local dig_hour = wibox.widget({
    widget = wibox.container.background,
    {
        ...
        halign = "center",
        format = maker.text(colors.orange, " Regular 22", "%H"),
    },
})
...
local dig_minute = wibox.widget({
    widget = wibox.container.background,
    {
        widget = wibox.widget.textclock,
        halign = "center",
        format = maker.text(colors.gray, " Regular 20", "%M"),
    },
})
...
local dig_sep = wibox.widget({
    widget = wibox.container.background,
    {
        ...
        markup = maker.text(colors.gray, " Regular 22", ":"),
    },
})
...
awesome.connect_signal("change::theme", function()
    ...
    clock_widget.border_color = colors.fg
end)
